    ...
    return (
        <main>
            ...
            <div className="social--main-container">
                <a href="www.bjornworrall@gmail.com"><button><i className="fa fa-envelope-square"></i>Email</button></a>
                <a href="www.bjornworrall@gmail.com"><button className="linkedin" > <i  className="fa fa-linkedin-square" aria-hidden="true"></i>
                                                                LinkedIn</button></a>
            </div>
